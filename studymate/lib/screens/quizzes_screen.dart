...
class _QuizzesScreenState extends State<QuizzesScreen> {
  ...
  Widget build(BuildContext context) {
    final List<_QuizItem> allQuizzes = [
      const _QuizItem('Matemática - Funções Quadráticas', '⚡ 10 Questões'),
      const _QuizItem('História do Brasil: República', '⚡ 15 Questões'),
      const _QuizItem('Biologia - Genética Básica', '⚡ 10 Questões'),
      const _QuizItem('Química - Cadeias Carbônicas', '⚡ 20 Questões'),
      ..._customQuizzes,
    ];
